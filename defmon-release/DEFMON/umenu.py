...
class MenuScreen:
    ...
    def add_parent(self) -> int:
        return 1 if self.parent is not None else 0

    def compute_visible_items(self):
        self._visible_items = []
    ...
    def count(self) -> int:
        elements = len(self._visible_items)
        return elements + self.add_parent()
...
class Menu:
    ...
    def draw(self):
        ...
        self.current_screen.compute_visible_items()
